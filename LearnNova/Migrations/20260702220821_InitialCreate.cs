        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeachStage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentQuestions_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentProgressRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContentProgressRecords_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContentProgressRecords_CourseContents_ContentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentProgressRecords_ContentId",
                table: "ContentProgressRecords",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_ContentProgressRecords_StudentId",
                table: "ContentProgressRecords",
                column: "StudentId");
